...
int main()
{
    ...
    // Indica que este proceso es el nieto
    printf("\n\t\t\t --> Soy el nieto, Mi PID es: %d\n", GetCurrentProcessId());

    // Bucle para crear 3 procesos hijos
    for(j = 0; j < 3; j++)
    {
        ...
        if(!CreateProcess(NULL, "sustitucion_2_3", NULL, NULL, FALSE, 0, NULL, NULL, &si, &pi))
        {
