 ...
 * 
 * Esta función crea el directorio 'resultados' si no existe, construye la ruta
...
int main()
{
    ...
    printf("Soy el proceso raíz. PID: %d\n", getpid()); // Imprime el PID del proceso raíz.

    int pid_raiz = getpid(); // Almacena el PID del proceso raíz.
    ...
    for (int i = 1; i <= 6; i++)
    {
        ...
        if (id_proc < 0)
        {
            perror("fork fallido"); // Manejo de errores en la creación del proceso.
            exit(1);
        } 
        else if (id_proc == 0) // Código del proceso hijo.
        {
            ...
            switch (i)
            {
                case 1:
                    ...
                    SumarMatrices(Matrizuno, Matrizdos, Resultado); // Suma de matrices.
                    Archivo(Resultado, "Suma.txt", "Suma de matrices", 'i'); // Guarda el resultado en un archivo.
                    break;
                case 2:
                    printf("\tRealizo la resta de matrices");
                    RestarMatrices(Matrizuno, Matrizdos, Resultado); // Resta de matrices.
                ...
                case 3:
                    ...
                    MultiplicarMatrices(Matrizuno, Matrizdos, Resultado); // Multiplicación de matrices.
                ...
                case 4:
                    ...
                    Archivo(Traspuestauno, "Transpuesta1.txt", "Traspuesta de la Matriz 1", 'i'); // Guarda la transpuesta en un archivo.
                    Archivo(Traspuestados, "Transpuesta2.txt", "Traspuesta de la Matriz 2", 'i'); // Guarda la transpuesta en un archivo.
                    break;
                case 5:
                    ...
                    break;
                case 6:
                    execlp("cat", "cat", "resultados/Suma.txt", "resultados/Resta.txt", "resultados/Multiplicacion.txt", "resultados/Transpuesta1.txt", "resultados/Transpuesta2.txt", "resultados/Inversa1.txt", "resultados/Inversa2.txt", NULL); // Muestra el contenido de los archivos.
                    break;
            }
