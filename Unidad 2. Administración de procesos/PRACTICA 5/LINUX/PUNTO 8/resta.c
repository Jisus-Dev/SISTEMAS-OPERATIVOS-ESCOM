...
/**
 * Escribe el resultado de la resta de matrices en un archivo.
 * 
...
void Archivo(int matriz[N][N])
{
    ...
    snprintf(ruta_archivo, sizeof(ruta_archivo), "resultados/Resta.txt");
...
/**
 * Función principal que realiza la resta de matrices.
 * 
